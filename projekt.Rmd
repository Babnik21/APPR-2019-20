...
```{r graf_ izji_ast, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.cap='Grafa višine in asistenc za 36 minut in na tekmo.'}
graf_nizji_ast
```

```{r graf_nizji_ft_36, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.cap='Graf višine, prostih metov in metov iz igre na 36 minut in na tekmo.'}
grid.arrange(graf_nizji_ft_36, graf_nizji_ft_annual, graf_nizji_fg_36, graf_nizji_fg_annual)
```


```{r map_svet, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.cap='Zemljevid držav rojstva košarkašev'}
map_svet
```


```{r zemljevid_zda, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.cap='Zemljevid držav rojstva aneriških košarkašov'}
zemljevid_zda
```

```{r map_ast_tov, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, fig.cap='Zemljevid ast-tov ratio'}
map_ast_tov
```
