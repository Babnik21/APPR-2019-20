...
V svoji projektni nalogi sem analiziral košarkarje lige NBA 
od leta 1980 naprej. Igralce sem analiziral na podlagi osebnih
podatkov, kot so višina, teža, rojstna država, ter njihove
statistike na tekmah (dosežene točke, skoki, asistence, itd.),
ter iskal povezave med njimi. 
...
Podatke imamo v dveh razpredelnicah v obliki *tidy data*. Večino kategorij najdemo v obeh razpredelnicah; razlika je, da so v drugi tabeli podatki preračunani, da predstavljajo statistiko, ki naj bi jo igralec dosegal z minutažo 36 minut na tekmo. 
